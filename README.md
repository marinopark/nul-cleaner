...
1. Open the [Releases page](../../releases) and grab the latest `nulCleaner.exe`.
2. Double-click it. There is nothing to install.
3. Pick a folder, hit **Find NUL files**, then **Delete selected**.

> **Heads up — Windows SmartScreen warning**
> The binary isn't code-signed yet, so the first time you launch it Windows will show a blue "Windows protected your PC" screen.
>
...
1. [Releases 페이지](../../releases)에서 `nulCleaner.exe` 다운로드
2. 더블클릭으로 실행 (설치 불필요)
